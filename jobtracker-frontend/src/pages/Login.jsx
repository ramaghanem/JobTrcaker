                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        >
                            <svg className="w-5 h-5" viewBox="0 0 48 48">
                                ...
                                <path fill="#4CAF50" d="M24 44c5.2 0 10-2 13.5-5.3l-6.2-5.2C29.2 36 26.8 37 24 37c-5.2 0-9.6-3.3-11.2-8l-6.5 5C9.6 39.5 16.2 44 24 44z"/>
                                <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-1.1 3-3.4 5.4-6.2 6.9l6.2 5.2C39.7 36.2 44 30.7 44 24c0-1.3-.1-2.7-.4-3.5z"/>
                            </svg>
