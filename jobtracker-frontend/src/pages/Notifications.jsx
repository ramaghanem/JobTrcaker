...
//               <div
//                 key={n.id}
//                 className={`bg-white border rounded-xl p-5 flex justify-between items-start gap-4 transition ${
//                   !n.read_at
...
//                     className="text-xs text-green-500 hover:underline whitespace-nowrap"
//                   >
//                     Mark as read
//                   </button>
//                 )}
